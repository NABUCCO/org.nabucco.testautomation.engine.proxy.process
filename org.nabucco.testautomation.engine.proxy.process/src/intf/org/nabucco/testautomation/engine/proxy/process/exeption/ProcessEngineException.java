 ...
 */
public class ProcessEngineException extends SubEngineException {
    ...
    public ProcessEngineException(Exception cause) {
        super(cause);
    }

    public ProcessEngineException(String message, Exception cause) {
        super(message, cause);
    }
