 ...
 */
public abstract class AbstractShellScriptCommand extends AbstractProxyCommand
		implements ShellScriptCommand {

	private static final NBCTestLogger logger = NBCTestLoggingFactory
			.getInstance().getLogger(ShellScriptCommand.class);
