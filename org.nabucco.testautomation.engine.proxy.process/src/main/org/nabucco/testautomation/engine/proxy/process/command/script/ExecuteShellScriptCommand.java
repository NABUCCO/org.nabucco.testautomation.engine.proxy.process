...
public class ExecuteShellScriptCommand extends AbstractShellScriptCommand {
    ...
    /**
     * Creates a new {@link ExecuteShellScriptCommand} instance.
     */
     ...
     */
    @Override
    public PropertyList execute(Metadata metadata, PropertyList properties) throws ShellScriptException {
    ...
    private String getCommand(Metadata metadata) throws ShellScriptException {
        ...
        TextProperty prop = (TextProperty) PropertyHelper.getFromList(metadata.getPropertyList(), PropertyType.TEXT,
                COMMAND);
