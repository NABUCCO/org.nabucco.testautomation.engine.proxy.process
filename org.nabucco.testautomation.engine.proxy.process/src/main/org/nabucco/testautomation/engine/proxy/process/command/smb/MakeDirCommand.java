 ...
 */
class MakeDirCommand extends AbstractSMBCommand implements SMBCommand {

    /**
     * Creates a new {@link MakeDirCommand} instance.
     */
    public MakeDirCommand(NtlmPasswordAuthentication auth) {
        super(auth);
    }
    ...
    public PropertyList executeCallback(Metadata metadata, PropertyList properties) throws SMBException, IOException {
        ...
        start();
        new SmbFile(pathname, getAuthentication()).mkdir();
        stop();
        return null;
    }
