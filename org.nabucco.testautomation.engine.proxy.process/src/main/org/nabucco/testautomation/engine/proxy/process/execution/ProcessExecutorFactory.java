...
public final class ProcessExecutorFactory {
    ...
    private static ProcessExecutorFactory instance = null;
    ...
    public static final synchronized ProcessExecutorFactory getInstance() {
        if (instance == null) {
            instance = new ProcessExecutorFactory();
        }
        return instance;
    }
