...
final class ProcessExecutorImpl implements ProcessExecutor {
    ...
    private static final NabuccoLogger logger = NabuccoLoggingFactory.getInstance()
            .getLogger(ProcessExecutorImpl.class);
    ...
    @Override
    public final ProcessExecutionResult executeExternalProcess(final ProcessExecutionType type, final String command) {
        ...
        try {
            ...
            ProcessExecutionOutputHandler outHandler = new ProcessExecutionOutputHandler(is, outLogger);
            ProcessExecutionOutputHandler errHandler = new ProcessExecutionOutputHandler(err, errLogger);
